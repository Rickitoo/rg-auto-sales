...
<div class="page-hero">
    ...
    <div class="small-container">
        <div class="filters-box">
            <form method="GET" action="<?= h(public_url('products.php')) ?>">
                ...
                <div class="filters-actions">
                    ...
                    <a href="<?= h(public_url('products.php')) ?>" class="btn btn--outline">Limpar filtros</a>
                </div>
            </form>
        </div>
                ...
                <?php foreach ($carros as $c): ?>
                    ...
                    <div class="col-4 product-card">
                        ...
                        <div class="product-actions">
                            <a class="btn btn--small" href="<?= h(public_url('product-details.php?id=' . (int)$c['id'])) ?>">Detalhes</a>
                            <a class="btn btn--outline btn--small" href="<?= h(public_url('test_drive.php')) ?>">Test Drive</a>
