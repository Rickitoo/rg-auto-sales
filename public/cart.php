...
$ids = array_values(array_unique(array_map('intval', $_SESSION['interesse'])));
$res = false;

if (count($ids) > 0) {
    $ids_str = implode(',', $ids);
    $res = mysqli_query($conexao, "SELECT * FROM carros WHERE id IN ($ids_str)");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        <div class="navbar">
        <div class="logo">
           <a href="<?= h(public_url('index.php')) ?>"> <img src="<?= h(asset('ImagensRG/logo.png')) ?>" width="100px"></a>
        </div>
        <nav>
            <!-- Menu -->
             <ul id="MenuItems">  
        ...
        <a href="<?= h(public_url('cart.php')) ?>"><img src="<?= h(asset('ImagensRG/png-transparent-computer-icons-shopping-cart-basket-shopping-cart-text-hand-share-icon.png')) ?>" width="30px" height="30px"></a>
        <img src="<?= h(asset('ImagensRG/pngtree-hamburger-like-menu-black-glyph-ui-icon-icon-concept-settings-vector-png-image_47699556.jpg')) ?>" class="menu-icon" onclick="menutoggle()">
    </div>
    </div>
    ...
    <div class="small-container cart-page">
        <table>
            <?php if (!$res): ?>
                <tr><td>Nenhum carro selecionado.</td></tr>
            <?php endif; ?>
            <?php while($res && ($c = mysqli_fetch_assoc($res))): ?>
            <tr>
                <td>
                    <div class="cart-info">
                        <img src="<?= $c['imagem'] ?>">
                ...
                <td>
                    <a href="<?= h(public_url('leasing.php?carro_id=' . $c['id'])) ?>">Leasing</a>
                </td>
            </tr>
            <?php endwhile; ?>
            <tr>
            ...
            <tr>
                <td>
                    <div class="cart-info">
                        <img src="<?= h(asset('ImagensRG/IMG_5009.jpeg')) ?>">
                        <p>Audi Q5</p>
                        <small>price: $35.000</small>
                        <br>
                        <a href="<?= h(public_url('cart.php?add=' . $id)) ?>" class="btn btn--small">Guardar</a>
                        <a href="">Remover</a>
                    </div>
                </td>
             ...
             <tr>
                <td>
                    <div class="cart-info">
                        <img src="<?= h(asset('ImagensRG/IMG_5010.jpeg')) ?>">
             ...
             <tr>
                <td>
                    <div class="cart-info">
                        <img src="<?= h(asset('ImagensRG/IMG_5011.jpeg')) ?>">
    ...
    <div class="container">
        <div class="row">
            <div class="footer-col-1">
                ...
                <div class="app-logo">
                    <img src="<?= h(asset('ImagensRG/AppStore.png')) ?>" >
                    <img src="<?= h(asset('ImagensRG/pngtree-google-play-store-vector-png-image_9183318.png')) ?>" >
                </div>
            </div>
             <div class="footer-col-2">
                <img src="<?= h(asset('ImagensRG/logo.png')) ?>">
