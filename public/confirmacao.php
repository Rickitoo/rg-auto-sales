...
<div class="wrap">
  ...
  <div class="card">
    ...
    <div class="actions">
      ...
      <a class="btn btn-outline" href="<?= h(public_url('index.php')) ?>">Voltar ao início</a>
      <a class="btn btn-outline" href="<?= h(public_url('test_drive.php')) ?>">Novo agendamento</a>
      <a class="btn btn-outline" href="<?= h(url('admin/admin.php')) ?>">Admin</a>
    </div>
