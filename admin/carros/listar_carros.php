...
<div class="list-card">
    <div class="section-head">
        ...
        <div class="top-actions">
            <a href="<?= h(url('admin/dashboard.php')) ?>" class="btn btn-secondary">Dashboard</a>
        ...
        <table>
            ...
            <?php if ($res && mysqli_num_rows($res) > 0): ?>
                <?php while ($carro = mysqli_fetch_assoc($res)): ?>
                    ...
                    $imgSrc = !empty($capa) ? fotoCarroUrl(['imagem' => $capa]) : "";
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="actions">
                                <a href="<?= h(url('admin/carros/editar_carro.php?id=' . $idCarro)) ?>" class="btn-primary">Editar</a>
                                <a href="<?= h(url('admin/gerir_fotos.php?id=' . $idCarro)) ?>" class="btn-dark">Fotos</a>
