      ...
      <div class="card item"
        ...
        <div class="grid">
          <div>
            ...
            <div class="muted">Data: <?php echo h($r['data_registo']); ?></div>
          </div>
        ...
        <div class="row">
          ...
          <!-- Mudar status -->
          <form action="<?= h(url('admin/vendas/vendedor_status.php')) ?>" method="POST" style="display:flex; gap:8px; align-items:center;">
            <input type="hidden" name="id" value="<?php echo $id; ?>">
          ...
          <!-- Apagar -->
          <form action="<?= h(url('admin/vendas/vendedor_apagar.php')) ?>" method="POST" onsubmit="return confirm('Apagar este pedido?');" style="display:inline;">
            <input type="hidden" name="id" value="<?php echo $id; ?>">
            <input type="hidden" name="token" value="<?php echo h($_SESSION['csrf_token']); ?>">
