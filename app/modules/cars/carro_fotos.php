...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['upload_fotos'])) {
    ...
    if (!isset($_FILES['fotos']) || empty($_FILES['fotos']['name'][0])) {
        ...
        if ($enviadas > 0) {
            redirect_to('app/modules/cars/carro_fotos.php?carro_id=' . $carro_id . '&upload=ok');
        } else {
...
<div class="small-container">
    <div class="topbar">
        ...
        <div style="display:flex; gap:10px; flex-wrap:wrap;">
            ...
            <a class="btn btn--outline" href="<?= h(url('app/modules/cars/listar_carros.php')) ?>">← Carros</a>
