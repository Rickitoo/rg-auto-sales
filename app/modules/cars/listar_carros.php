...
redirect_to('admin/carros/listar_carros.php' . (($_SERVER['QUERY_STRING'] ?? '') !== '' ? '?' . $_SERVER['QUERY_STRING'] : ''));
...
<div class="list-card">
    <div class="section-head">
        ...
        <div class="top-actions">
            ...
            <a href="<?= h(url('app/modules/cars/adicionar_carro.php')) ?>" class="btn btn-primary">+ Adicionar Carro</a>
        </div>
    </div>
</div>
...
<div class="list-card">
    <form method="GET" class="filtros">
        ...
        <a href="<?= h(url('app/modules/cars/listar_carros.php')) ?>" class="btn btn-secondary">Limpar</a>
    </form>
</div>
